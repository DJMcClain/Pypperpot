...
class MaskWidget(QMainWindow):
    def __init__(self):
        ...
        MaskWidget.loadMaskPrompt = QPushButton('Load Mask')
        saveMaskPrompt = QPushButton('Save Mask')
        MaskWidget.loadMaskPrompt.clicked.connect(self.on_LoadMa_clicked)
        ...
        self.layoutH4.addWidget(MaskWidget.loadMaskPrompt)
...
class SimMaskWidget(QMainWindow):
    def __init__(self):
        super(SimMaskWidget, self).__init__()
        self.central_widget = QWidget()
        self.layoutV1 = QVBoxLayout() # File Params column
        self.layoutH1 = QHBoxLayout() # Load/Save Image
        self.layoutH4 = QHBoxLayout() # Save/Load Mask
        ...
        SimMaskWidget.diamIn = hole_diam_read()
        SimMaskWidget.numHoles = hole_num_read()
        SimMaskWidget.sepIn = hole_sep_read()
        SimMaskWidget.Mask2ScrnIn = mask2Scrn_read()
        SimMaskWidget.Calibration = calib_read()
        SimMaskWidget.hole_err = hole_err_read()
        SimMaskWidget.sigL = mask2Scrn_err_read()
        SimMaskWidget.puncert = calib_err_read()
